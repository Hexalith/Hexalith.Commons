<<<<<<< HEAD:.agents/skills/bmad-quick-dev/spec-template.md
---
title: '{title}'
...
**Manual checks (if no CLI):**
- WHAT_TO_INSPECT_AND_EXPECTED_STATE
>>>>>>> 326373f (chore: sync workspace updates):_bmad/bmm/workflows/bmad-quick-flow/bmad-quick-dev-new-preview/tech-spec-template.md
