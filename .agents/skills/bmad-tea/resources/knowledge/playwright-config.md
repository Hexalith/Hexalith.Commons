<<<<<<< HEAD:.agents/skills/bmad-tea/resources/knowledge/playwright-config.md
...
_Source: Playwright book repo, enterprise configuration example, Murat testing philosophy (lines 216-271)._
>>>>>>> 326373f (chore: sync workspace updates):_bmad/tea/testarch/knowledge/playwright-config.md
