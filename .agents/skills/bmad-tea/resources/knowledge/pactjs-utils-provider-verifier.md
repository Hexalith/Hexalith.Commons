<<<<<<< HEAD:.agents/skills/bmad-tea/resources/knowledge/pactjs-utils-provider-verifier.md
...
_Source: @seontechnologies/pactjs-utils provider-verifier module, pact-js-example-provider CI workflows_
>>>>>>> 326373f (chore: sync workspace updates):_bmad/tea/testarch/knowledge/pactjs-utils-provider-verifier.md
