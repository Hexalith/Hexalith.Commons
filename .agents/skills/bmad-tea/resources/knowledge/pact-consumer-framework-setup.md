<<<<<<< HEAD:.agents/skills/bmad-tea/resources/knowledge/pact-consumer-framework-setup.md
...
- `pactjs-utils-request-filter.md` — Auth injection for provider verification
- `contract-testing.md` — Foundational CDC patterns and resilience coverage
>>>>>>> 326373f (chore: sync workspace updates):_bmad/tea/testarch/knowledge/pact-consumer-framework-setup.md
