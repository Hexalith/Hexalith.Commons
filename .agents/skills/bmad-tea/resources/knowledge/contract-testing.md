<<<<<<< HEAD:.agents/skills/bmad-tea/resources/knowledge/contract-testing.md
...
_Source: Pact consumer/provider sample repos, Murat contract testing blog, Pact official documentation, @seontechnologies/pactjs-utils library_
>>>>>>> 326373f (chore: sync workspace updates):_bmad/tea/testarch/knowledge/contract-testing.md
