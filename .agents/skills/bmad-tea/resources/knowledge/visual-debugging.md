<<<<<<< HEAD:.agents/skills/bmad-tea/resources/knowledge/visual-debugging.md
...
_Source: Playwright official docs, Murat testing philosophy (visual debugging manifesto), enterprise production debugging patterns_
>>>>>>> 326373f (chore: sync workspace updates):_bmad/tea/testarch/knowledge/visual-debugging.md
